...
-agents faroo:search.FarooSA\;viewer:view.VA\;crawler:dipre.DA\(Isaac\ Asimov\#The\ Robots\ of\ Dawn,David\ Brin\#Startide\ Rising\) &
sleep 1
java -cp $CP jade.Boot -container -local-host 127.0.0.1 -host localhost -port 1099 \
-agents bing:search.BingSA\;crawler2:dipre.DA\(Charles\ Dickens\#Great\ Expectations,William\ Shakespeare\#The\ Comedy\ of\ Errors\)
